let attack_on_titan_file = new XMLHttpRequest();

attack_on_titan_file.open("get", "https://vivek0018.github.io/Files.Animerulz/scripts/JSON/more-from-attack-on-titan.json", true);
attack_on_titan_file.send();

attack_on_titan_file.onload = function(){
