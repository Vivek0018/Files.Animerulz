let black_clover_file = new XMLHttpRequest();

black_clover_file.open("get", "/scripts/JSON/more-from-black-clover.json", true);
black_clover_file.send();

black_clover_file.onload = function(){
