...
function select(element){
    ...
    window.open("https://animerulz.xyz/" + selectData.replace(/\s/g, "").replace(":", "").replace(".", "").replace(";", "").replace(",", "" ), "_self");
}
...
// else{
try{
    document.getElementById("a-home-anchor-tag").setAttribute("href", "http://127.0.0.1:5500/");
    var activeAnime = document.getElementById("a-active-page-tag");
    activeAnime.setAttribute("href", "http://127.0.0.1:5500/" + activeAnime.textContent.replace(/\s/g, ""));
}
catch{}
try{
